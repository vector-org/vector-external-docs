...
export function CustomFooter() {
  return (
    <div className="w-full bg-white border-t border-grey-200 mt-auto">
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="font-semibold text-grey-900 mb-4">Company</h3>
          ...
          <div>
            <h3 className="font-semibold text-grey-900 mb-4">About</h3>
            <ul className="space-y-2 text-grey-600">
          ...
          <div>
            ...
            <p className="text-grey-600 mb-2">hello@playonvector.com</p>
            <p className="text-grey-600 mb-4">Join us on social media</p>
            <div className="flex space-x-4">
              <Link href="https://x.com/playonvector" className="text-grey-600 hover:text-vector-teal">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </Link>
              <Link href="https://discord.com/invite/playonvector" className="text-grey-600 hover:text-vector-teal">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
